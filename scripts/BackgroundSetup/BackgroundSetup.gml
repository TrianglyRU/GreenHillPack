function BackgroundSetup()
{
	...
	{	
		...
		case Screen_Title:
		{
			...
			// Setup layers
			background_layer_setup(0, 0, -8,  0.375, 0, -1,    0, 0,     0);
			background_layer_setup(1, 0, 24,  0.375, 0, -0.5,  0, 0,     0);
			background_layer_setup(2, 0, 40,  0.375, 0, -0.25, 0, 0,     0);
			background_layer_setup(3, 0, 56,  0.375, 0, 0,     0, 0,     0);
			background_layer_setup(4, 0, 104, 0.5,   0, 0,     0, 0,     0);
			background_layer_setup(5, 0, 144, 0.5,   0, 0,     1, 0.005, 0);
		...
		case Stage_GHZ3:
		{
			...
			background_layer_setup(5, 0, 120, 0.5,   -0.032, 0,     1, 0.005, 0);
